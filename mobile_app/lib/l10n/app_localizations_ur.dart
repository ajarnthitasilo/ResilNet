...
class AppLocalizationsUr extends AppLocalizations {
  ...
  @override
  String get onboardingFriendsTitle => 'آسانی سے دوستوں کو شامل کریں۔';

  @override
  String get onboardingFriendsBody =>
      'شناخت سے ایک QR کا اشتراک کریں، یا عوامی کلیدوں کا تبادلہ کرنے کے لیے کسی دوست کا QR اسکین کریں۔';
