...
class AppLocalizationsMl extends AppLocalizations {
  ...
  String feedMeshSubtitle(Object ble) {
    return 'സമീപത്തുള്ള സമപ്രായക്കാർ (BLE)';
  }
  ...
  @override
  String get onboardingFriendsTitle => 'സുഹൃത്തുക്കളെ എളുപ്പത്തിൽ ചേർക്കുക';

  @override
  String get onboardingFriendsBody =>
      'ഐഡൻ്റിറ്റിയിൽ നിന്ന് ഒരു QR പങ്കിടുക, അല്ലെങ്കിൽ പൊതു കീകൾ കൈമാറാൻ ഒരു സുഹൃത്തിൻ്റെ QR സ്കാൻ ചെയ്യുക';
