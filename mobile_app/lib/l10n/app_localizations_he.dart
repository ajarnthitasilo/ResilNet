...
class AppLocalizationsHe extends AppLocalizations {
  ...
  @override
  String get onboardingFriendsTitle => 'הוסף חברים בקלות';

  @override
  String get onboardingFriendsBody =>
      'שתף QR מ-Identity, או סרוק את ה-QR של חבר כדי להחליף מפתחות ציבוריים';
