...
class AppLocalizationsFa extends AppLocalizations {
  ...
  @override
  String get onboardingFriendsTitle => 'دوستان را به راحتی اضافه کنید';

  @override
  String get onboardingFriendsBody =>
      'یک QR را از Identity به اشتراک بگذارید، یا QR یک دوست را برای تبادل کلیدهای عمومی اسکن کنید';
