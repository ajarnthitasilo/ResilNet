...
**ระบบส่งข้อความฉุกเฉินแบบไร้บัญชี** — ใช้ได้ทั้งตอนมีเน็ตและไม่มีเน็ต ผ่าน Bluetooth ใกล้ตัว, ESP32 / LoRa ระยะกลาง, Nostr เมื่อออนไลน์ และทางเลือก **Local Wi‑Fi** / **Home node (Reticulum)** บน LAN

แอปเวอร์ชันปัจจุบัน: **1.9.64**  
เฟิร์มแวร์ ESP32: ดูในแอป / หน้าเฟิร์มแวร์ (อาจตามหรือใกล้เคียงเวอร์ชันแอป)
...
ดูสิ่งที่เปลี่ยนจากคู่มือรอบ 1.9.49: **[มีอะไรใหม่](guide/whats-new.md)**
